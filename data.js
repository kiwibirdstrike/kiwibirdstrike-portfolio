window.PORTFOLIO_DATA = {
  profile: {
    eyebrow: "STATISTICS · DATA · APPLIED AI",
    name: "이주성",
    lead:
      "통계와 데이터 분석을 기반으로 복잡한 업무를 구조화하고, 모델과 AI가 실제 의사결정에 쓰이도록 프로세스와 검증 기준을 설계합니다.",
    education: "충북대학교 정보통계학과 학사 · 석사과정",
    principles: [
      "프롬프트보다 반복 가능한 프로세스를 설계합니다.",
      "평균 성능보다 오류가 발생하는 위치와 비용을 확인합니다.",
      "자동화할 판단과 사람이 검토할 판단을 구분합니다."
    ],
    links: [
  ...
  tracks: [
    {
      ...
      title: "AI·에이전트 활용",
      summary:
        "분석과 판단 업무를 단계별 에이전트로 분해하고, 기억·실험·평가가 이어지는 프로세스를 설계합니다.",
    ...
    },
    {
      ...
      title: "바이오·의료 통계",
      summary:
        "예측 정확도뿐 아니라 통계적 추론과 도메인 타당성까지 확인해 결과가 연구 판단으로 이어지게 합니다.",
    ...
    },
    {
      ...
      title: "금융·퀀트 모델링",
      summary:
        "편향을 통제한 검증, 위험 관리, 실제 주문 제약을 함께 고려해 모델을 운영 가능한 판단 체계로 확장합니다.",
